	...
	describe 'setting up JDBC Configuration' do
		before :all do
			within 'form[name=dbform]' do
				fill_in 'dbConfigInfo.databaseUrl', with: 'jdbc:mysql://localhost/confluence?sessionVariables=storage_engine%3DInnoDB&useUnicode=true&characterEncoding=utf8'.gsub('localhost', @container_db.host)
