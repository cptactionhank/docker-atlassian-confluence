...
describe 'Atlassian Confluence with Embedded Database' do
	...
	include_examples 'a buildable Docker image', '.', { env: ["CATALINA_OPTS=-Xms3072m -Xmx3072m -Datlassian.plugins.enable.wait=#{Docker::DSL.timeout}"] }
...
describe 'Atlassian Confluence behind reverse proxy' do
	...
	include_examples 'a buildable Docker image', '.', {
		env: [
			"CATALINA_OPTS=-Xms3072m -Xmx3072m -Datlassian.plugins.enable.wait=#{Docker::DSL.timeout}",
